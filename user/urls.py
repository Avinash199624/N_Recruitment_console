...
urlpatterns = [
    ...
    path('public/neeri_user_personal_info/', NeeriPersonalInformation.as_view(), name="list-neeri-user-personal-info"),
    path('public/neeri_user_personal_info/<uuid:id>/', NeeriPersonalInformation.as_view(), name="neeri-user-personal-info"),
    ...
    path('filter_trainee/', TraineeSearchListView.as_view(), name="filter-trainee-list"),
