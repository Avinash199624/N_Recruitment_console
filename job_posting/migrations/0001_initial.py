    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ad_approval_id', models.CharField(blank=True, max_length=50, null=True)),
                ('pre_ad_description', models.TextField(blank=True, null=True)),
                ('post_ad_description', models.TextField(blank=True, null=True)),
                ...
                ('status', models.CharField(blank=True, choices=[('scheduled', 'Scheduled'), ('published', 'Published'), ('suspended', 'Suspended'), ('cancelled', 'Cancelled'), ('closed', 'Closed'), ('Archived', 'Archived')], max_length=30, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('draft', 'DRAFT'), ('submitted', 'SUBMITTED'), ('on hold', 'ON_HOLD'), ('approved', 'APPROVED'), ('rejected', 'REJECTED'), ('cancelled', 'CANCELLED'), ('closed', 'CLOSED')], max_length=30, null=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.CharField(blank=True, choices=[('1', '1'), ('2', '2'), ('3', '3'), ('4', '4')], max_length=30, null=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(blank=True, null=True)),
                ('is_deleted', models.BooleanField(default=False, help_text='Used for Soft Delete')),
                ('applied_job_status', models.CharField(blank=True, choices=[('document pending', 'DOCUMENT_PENDING'), ('received', 'RECEIVED'), ('accepted', 'ACCEPTED'), ('rejected', 'REJECTED'), ('shortlisted', 'SHORTLISTED'), ('offered', 'OFFERED'), ('hired', 'HIRED'), ('interview', 'INTERVIEW'), ('awaiting review', 'AWAITING_REVIEW'), ('closed', 'CLOSED'), ('appealed', 'APPEALED')], max_length=50, null=True)),
                ...
                ('appeal', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='appeal', to='job_posting.appealmaster')),
            ],
            options={
                'abstract': False,
            },
