...
urlpatterns = [
    ...
    # path(r"^create-user/?$", CreateUserView.as_view(), name="create-user"),
    # path(r"^get-user/?$", GetUserView.as_view(), name="get-user"),
    # path(r"^delete-user/?$", DeleteUserView.as_view(), name="delete-user"),
]
