...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('communication_template', '0002_auto_20210413_1936'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='comm_type',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='comm_type', to='communication_template.communicationtype'),
        ),
